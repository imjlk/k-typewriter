...
return array(
	'slug'         => 'sbs-typing-effect-block/announcement-strip',
	'title'        => __( 'Announcement Strip', 'sbs-typing-effect-block' ),
	'description'  => __( 'A compact banner for rotating launches, promos, or deadline reminders.', 'sbs-typing-effect-block' ),
...
<div class="wp-block-group alignfull has-text-color has-background" style="color:#f9fafb;background-color:#111827;border-radius:14px;padding-top:0.75rem;padding-right:1rem;padding-bottom:0.75rem;padding-left:1rem"><!-- wp:imjlk/sbs-typing-effect-block {"items":["Launch week pricing ends Friday.","Now shipping GitHub-based Playground previews.","Pause on hover to let visitors read every message."],"pauseOnHover":true,"deleteDelay":25,"pauseDelay":1500,"tagName":"p","style":{"typography":{"textAlign":"center","fontSize":"1rem","fontWeight":"600"}}} /--></div>
<!-- /wp:group -->
HTML,
);
