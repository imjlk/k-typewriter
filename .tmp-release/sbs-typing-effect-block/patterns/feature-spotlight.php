...
return array(
	'slug'          => 'sbs-typing-effect-block/feature-spotlight',
	'title'         => __( 'Feature Spotlight', 'sbs-typing-effect-block' ),
	'description'   => __( 'A practical section intro pattern for feature pages, launch sections, and campaign callouts.', 'sbs-typing-effect-block' ),
...
<!-- wp:imjlk/sbs-typing-effect-block {"items":["Announce one feature clearly.","Rotate benefit-led headlines.","Keep the section steady while copy changes."],"reserveLines":2,"verticalAlign":"middle","pauseOnHover":true,"tagName":"h2","style":{"typography":{"fontSize":"clamp(2rem,4vw,3rem)","lineHeight":"1.08","textAlign":"left"}}} /-->
