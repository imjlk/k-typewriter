...
return array(
	'slug'         => 'sbs-typing-effect-block/multilingual-spotlight',
	'title'        => __( 'Multilingual Spotlight', 'sbs-typing-effect-block' ),
	'description'  => __( 'A showcase pattern for Korean, English, and Arabic messaging in one polished section.', 'sbs-typing-effect-block' ),
...
<!-- wp:imjlk/sbs-typing-effect-block {"items":["한 글자씩, 리듬 있게.","Animate headlines in any language.","نص متحرك بإيقاع واضح."],"reserveLines":2,"verticalAlign":"middle","inlineLayout":false,"textDirection":"auto","tagName":"h2","style":{"typography":{"fontSize":"clamp(2.1rem,5vw,3.5rem)","lineHeight":"1.08","textAlign":"center"}}} /-->
