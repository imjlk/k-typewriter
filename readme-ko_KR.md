...
2026년 5월 11일 기준 WordPress 7.0은 아직 RC 단계입니다. 현재 7.0 RC 기준으로 로컬 smoke test를 돌리려면:
...
- GitHub Actions는 최소 지원 버전인 WordPress 6.6 환경과 현재 WordPress 7.0 RC 환경에서 smoke coverage를 함께 확인합니다.
