<?php
/**
 * Configure WordPress Playground demo pages for Stroke by stroke typing effect Block.
 *
 * @package KTypewriter
 */
...
( static function() {
	$sbs_typing_effect_block_patterns_dir = dirname( __DIR__ ) . '/patterns';
	$sbs_typing_effect_block_hero         = require $sbs_typing_effect_block_patterns_dir . '/hero-headline.php';
	$sbs_typing_effect_block_inline       = require $sbs_typing_effect_block_patterns_dir . '/inline-keyword-rotator.php';
	$sbs_typing_effect_block_announcement = require $sbs_typing_effect_block_patterns_dir . '/announcement-strip.php';
	$sbs_typing_effect_block_feature      = require $sbs_typing_effect_block_patterns_dir . '/feature-spotlight.php';
	$sbs_typing_effect_block_multilingual = require $sbs_typing_effect_block_patterns_dir . '/multilingual-spotlight.php';
	$sbs_typing_effect_block_split_hero   = require $sbs_typing_effect_block_patterns_dir . '/split-launch-hero.php';
	$sbs_typing_effect_block_editorial    = require $sbs_typing_effect_block_patterns_dir . '/editorial-section-lead.php';
	$sbs_typing_effect_block_error_prompt = require $sbs_typing_effect_block_patterns_dir . '/404-error-prompt.php';
	$sbs_typing_effect_block_terminal     = require $sbs_typing_effect_block_patterns_dir . '/terminal-loading-steps.php';

	$sbs_typing_effect_block_upsert_page = static function( $slug, $title, $content ) {
		...
		if ( is_wp_error( $page_id ) ) {
			throw new RuntimeException(
				esc_html( $page_id->get_error_message() )
			);
		}
	...
	$sbs_typing_effect_block_placeholder = '<!-- wp:paragraph --><p>Preparing demo…</p><!-- /wp:paragraph -->';
	$sbs_typing_effect_block_gallery_id  = $sbs_typing_effect_block_upsert_page(
		'k-typewriter-demo',
		'Stroke by stroke typing effect Block Pattern Gallery',
		$sbs_typing_effect_block_placeholder
	);
	$sbs_typing_effect_block_lab_id      = $sbs_typing_effect_block_upsert_page(
		'k-typewriter-layout-lab',
		'Stroke by stroke typing effect Block Stability Examples',
		$sbs_typing_effect_block_placeholder
	);
	$sbs_typing_effect_block_gallery_url = esc_url_raw(
		get_permalink( $sbs_typing_effect_block_gallery_id )
	);
	$sbs_typing_effect_block_lab_url     = esc_url_raw(
		get_permalink( $sbs_typing_effect_block_lab_id )
	);

	$sbs_typing_effect_block_sample_page = get_page_by_path(
		'sample-page',
		OBJECT,
		'page'
	);

	if ( $sbs_typing_effect_block_sample_page instanceof WP_Post ) {
		wp_trash_post( $sbs_typing_effect_block_sample_page->ID );
	}

	$sbs_typing_effect_block_gallery_intro = sprintf(
	<<<'HTML'
...
<p class="has-text-align-center" style="font-size:0.85rem;letter-spacing:0.14em;text-transform:uppercase">Stroke by stroke typing effect Block pattern gallery</p>
<!-- /wp:paragraph -->
...
<!-- /wp:group -->
HTML,
		$sbs_typing_effect_block_lab_url
	);

	$sbs_typing_effect_block_section_spacer = "\n<!-- wp:spacer {\"height\":\"2rem\"} -->\n<div style=\"height:2rem\" aria-hidden=\"true\" class=\"wp-block-spacer\"></div>\n<!-- /wp:spacer -->\n";

	$sbs_typing_effect_block_experimental_intro = <<<'HTML'
...
<h2 class="wp-block-heading has-text-align-center" style="font-size:clamp(1.9rem,4vw,3rem);line-height:1.08">Try Stroke by stroke typing effect Block inside layouts people actually build.</h2>
<!-- /wp:heading -->
...
HTML;
	...
	$sbs_typing_effect_block_gallery_footer = sprintf(
	<<<'HTML'
...
HTML,
	...
	$sbs_typing_effect_block_gallery_content = implode(
		$sbs_typing_effect_block_section_spacer,
		array(
			$sbs_typing_effect_block_gallery_intro,
			$sbs_typing_effect_block_hero['content'],
			$sbs_typing_effect_block_inline['content'],
			$sbs_typing_effect_block_announcement['content'],
			$sbs_typing_effect_block_feature['content'],
			$sbs_typing_effect_block_multilingual['content'],
			$sbs_typing_effect_block_experimental_intro,
			$sbs_typing_effect_block_split_hero['content'],
			$sbs_typing_effect_block_editorial['content'],
			$sbs_typing_effect_block_error_prompt['content'],
			$sbs_typing_effect_block_terminal['content'],
			$sbs_typing_effect_block_gallery_footer,
		)
	);

	$sbs_typing_effect_block_lab_content = sprintf(
	<<<'HTML'
...
<p class="has-text-align-center" style="font-size:0.85rem;letter-spacing:0.14em;text-transform:uppercase">Stroke by stroke typing effect Block stability examples</p>
<!-- /wp:paragraph -->
...
<!-- wp:imjlk/sbs-typing-effect-block {"items":["Short","A much longer line that wraps when reserve lines are not helping."],"reserveLines":1,"pauseDelay":1400,"tagName":"p","style":{"typography":{"fontSize":"1.2rem"}}} /--></div>
<!-- /wp:column -->
...
<!-- wp:imjlk/sbs-typing-effect-block {"items":["Short","A much longer line that wraps when reserve lines are not helping."],"reserveLines":3,"verticalAlign":"middle","pauseDelay":1400,"tagName":"p","style":{"typography":{"fontSize":"1.2rem"}}} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:imjlk/sbs-typing-effect-block {"items":["teams","distributed product teams","global editorial systems"],"inlineLayout":true,"inlineWidthMode":"auto","tagName":"span","style":{"typography":{"fontSize":"1.25rem","fontWeight":"700"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:imjlk/sbs-typing-effect-block {"items":["teams","distributed product teams","global editorial systems"],"inlineLayout":true,"inlineWidthMode":"measure","tagName":"span","style":{"typography":{"fontSize":"1.25rem","fontWeight":"700"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:imjlk/sbs-typing-effect-block {"items":["small teams","international editorial systems"],"inlineLayout":true,"inlineWidthMode":"characters","inlineWidthCh":8,"tagName":"span","style":{"typography":{"fontSize":"1.15rem","fontWeight":"700"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:imjlk/sbs-typing-effect-block {"items":["small teams","international editorial systems"],"inlineLayout":true,"inlineWidthMode":"measure","tagName":"span","style":{"typography":{"fontSize":"1.15rem","fontWeight":"700"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
HTML,
		$sbs_typing_effect_block_gallery_url
	);

	$sbs_typing_effect_block_gallery_id = $sbs_typing_effect_block_upsert_page(
		'k-typewriter-demo',
		'Stroke by stroke typing effect Block Pattern Gallery',
		$sbs_typing_effect_block_gallery_content
	);
	$sbs_typing_effect_block_lab_id     = $sbs_typing_effect_block_upsert_page(
		'k-typewriter-layout-lab',
		'Stroke by stroke typing effect Block Stability Examples',
		$sbs_typing_effect_block_lab_content
	);

	$sbs_typing_effect_block_demo_css = sprintf(
	...
	body.page-id-%2$d .entry-content > .wp-block-group.alignfull:first-child { margin-top: 0 !important; }',
		$sbs_typing_effect_block_gallery_id,
		$sbs_typing_effect_block_lab_id
	);

	if ( function_exists( 'wp_update_custom_css_post' ) ) {
		wp_update_custom_css_post( $sbs_typing_effect_block_demo_css );
	}

	update_option( 'blogname', 'Stroke by stroke typing effect Block Playground Preview' );
	update_option( 'blogdescription', 'Explore ready-to-use Stroke by stroke typing effect Block patterns and a separate stability examples page.' );
	update_option( 'show_on_front', 'page' );
	update_option( 'page_on_front', (int) $sbs_typing_effect_block_gallery_id );
} )();
